    ...
    <div className="space-y-3">
      {types.map((type) => {
        ...
        return (
          <div
            key={type}
            className="bg-background-secondary rounded-lg border border-background-primary overflow-hidden"
          >
            <button
              onClick={() => toggleSection(type)}
              className="w-full flex items-center justify-between p-4 hover:bg-background-card transition-colors"
            >
            ...
            {isExpanded && (
              <div className="border-t border-background-primary">
                {hasMemories ? (
                              ...
                              <div className="mt-2 space-y-2">
                                ...
                                <div className="flex gap-2">
                                  <button
                                    ...
                                    disabled={isPending}
                                    className="flex items-center gap-1 text-xs bg-accent-primary text-black px-2 py-1 rounded-md font-medium hover:bg-accent-primary/90 disabled:opacity-50"
                                  >
                          ...
                          {editingId !== memory.id && (
                            <div className="flex items-center gap-1 shrink-0">
                              <button
                                ...
                                className="p-1.5 rounded-md text-text-muted hover:text-accent-primary hover:bg-background-card transition-colors"
                              >
                                {memory.pinned ? (
                              ...
                              <button
                                ...
                                className="p-1.5 rounded-md text-text-muted hover:text-text-primary hover:bg-background-card transition-colors"
                              >
                              ...
                              <button
                                ...
                                className="p-1.5 rounded-md text-text-muted hover:text-red-400 hover:bg-background-card transition-colors"
                              >
                  ...
                  <div className="p-6 text-center">
                    ...
                    <p className="text-sm text-text-muted">
                      No memories in this category yet. The AI will learn these as you use CoreOS.
                    </p>
                  </div>
                )}
              </div>

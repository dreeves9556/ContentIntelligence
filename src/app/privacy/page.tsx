      ...
      <main className="bg-background-primary">
        <article className="max-w-3xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
          ...
          <div className="space-y-8 text-text-muted leading-relaxed">
            <section>
              <p>
                This Privacy Policy describes how <strong>The Local Post</strong> (&ldquo;we,&rdquo; &ldquo;us,&rdquo; &ldquo;our,&rdquo; or &ldquo;the Service&rdquo;)
            ...
            <section id="information-we-collect">
              ...
              <ul className="list-disc list-inside space-y-2 text-sm">
                <li><strong>Authentication tokens:</strong> JSON Web Tokens (JWTs) used to maintain your session. If you select &ldquo;Remember Me,&rdquo; the session token persists for up to 30 days; otherwise, it expires after 24 hours.</li>
              ...
              <p className="mb-3">The Service maintains an AI memory system (&ldquo;Brand Brain&rdquo;) that automatically learns and stores strategic observations about you and your content performance. These memories may include:</p>
              <ul className="list-disc list-inside space-y-2 text-sm">
            ...
            <section id="cookies">
              ...
              <ul className="list-disc list-inside space-y-2 text-sm">
                <li><strong>Session JWT:</strong> We issue a JSON Web Token stored as an HTTP-only cookie to authenticate your session. With &ldquo;Remember Me,&rdquo; this token is valid for up to 30 days. Without it, the token expires after 24 hours. The token contains your user ID, email, role, subscription plan, and session expiry timestamp — but not your password.</li>
            ...
            <section id="changes">
              ...
              <p className="text-sm">We may update this Privacy Policy from time to time to reflect changes in our practices, legal requirements, or the features of the Service. When we make material changes, we will notify you by email and/or by posting a prominent notice within the Service. We will also update the &ldquo;Last updated&rdquo; date at the top of this page. Your continued use of the Service after any changes indicates your acceptance of the updated Privacy Policy. We encourage you to review this page periodically.</p>
            </section>
